...
export const fundingOpportunityFirstStepSchema = z.object({
  ...
  targetWomenFounder: z.boolean().optional(),
  targetProductStage: z.string().optional(),
  targetFundingStage: z.string().optional(),
  targetProductStageList: z.array(z.string()).optional(),
  targetFundingStageList: z.array(z.string()).optional(),
  description: z.string().min(2, "Minimum 2 characters"),
