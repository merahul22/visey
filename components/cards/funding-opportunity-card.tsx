...
const FundingOportunityCard = () => {
  return (
    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:gap-10">
      <div className="border-2 rounded-xl px-4 py-4 space-y-2">
        <div className="space-y-2 lg:flex gap-2">
          ...
          <div className="space-y-2">
            <div className="flex gap-1">
              ...
              <p className="font-semibold text-lg max-w-[60px]">Under Review</p>
            </div>
...
export default FundingOportunityCard;
