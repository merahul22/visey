//this page renders markdown content from a file
import fs from "fs";
...
export const metadata: Metadata = {
  ...
  description: "A comprehensive guide to using the Business Model Canvas for strategic business transformation. Learn how to map out and improve your business model effectively.",
};
...
const getMarkdownContent = () => {
  const filePath = path.join(
    process.cwd(),
    "blog-files",
    "business-model-canvas-template-your-complete-guide-to-strategic-business-transformation.md"
  );
  ...
  return (
    <div className="max-w-[1000px] mx-auto mt-16 mb-24 px-4">
      ...
      <h2 className="text-2xl font-medium mt-2">
        A comprehensive guide to using the Business Model Canvas for strategic business transformation. Learn how to map out and improve your business model effectively.
      </h2>
      ...
      <div className="mt-4 flex items-center justify-center">
        <Image
          ...
          alt="Business Model Canvas Image"
          width={1000}
          height={500}
        />
      </div>
