  ...
  return <div className="p-10">
    ...
    <div className="pt-10">
      <div className="text-center">
        ...
        <p className="pt-1">Perfect for increasing business awareness and driving engagement</p>
      </div>
      <div>
        <BusinessPricingPage />
      </div>
    ...
    <div className="pt-24">
      <div className="text-center">
        ...
        <p className="pt-1">Create targeted ad campaigns and get more responses</p>
      </div>
      <div>
