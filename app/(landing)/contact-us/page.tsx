import {PhoneCall, Envelope, WhatsappLogo} from "@phosphor-icons/react/dist/ssr";
...
const page = () => {
  return <div className="m-8 mb-24 p-8 border-2 rounded-xl">
    ...
    <div className="pt-16">
      <h2 className="font-gothic font-semibold text-2xl mb-8 text-center">How can we help?</h2>
        ...
        >
          <div className="flex flex-col h-full justify-between">
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <h3 className="font-gothic font-medium text-hero leading-tight">
                  Real-Time Support
                </h3>
            ...
            <div className="flex justify-end pt-16">
              <Button
                  variant="landing"
                  className="font-gothic font-semibold w-full py-3 px-10 text-lg text-base-black hover:scale-105 transition-transform"
              >
                <Link
                    href="/"
    ...
    <div className="pt-16">
      <h2 className="font-gothic font-semibold text-2xl text-center">We are looking forward to assiting you!</h2>
      <form
          action=""
